...
## Nível 1:
Aqui está o problema e a solução, e como implementar, apenas escute.

## Nível 2:
Aqui está o problema e a solução, lembre como implementar.

## Nível 3:
Aqui está o problema, teste você a solução.
...
## Nível 6:
Proveja problemas mutáveis e suas variáveis para provas úteis.
```